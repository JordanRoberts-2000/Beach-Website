...
const TextInputLabel = ({children, className, variant, size, valid, HtmlId}: LabelProps) => {
  return (
    <div className={twMerge(variantsWrapper({variant, size, valid}))}>
        <div className={twMerge(variantsLeft({variant, size, valid}))}></div>
        <label htmlFor={HtmlId} className={twMerge(variants({variant, size, valid, className}))}>
            {children}
        </label>
        <div className={twMerge(variantsRight({variant, size, valid}))}></div>
    </div>
  )
}
