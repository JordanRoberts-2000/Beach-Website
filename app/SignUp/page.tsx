...
const page = () => {
  return (
    <div className='h-[90vh] flex flex-col'>
        <h3 className=' translate-y-[calc(-100%-8px)] mx-auto text-3xl font-[600] z-40 font-playfairDisplay'>Register</h3>
        <div className='flex flex-col'>
            ...
            <div className='mt-2 mx-auto flex gap-4 justify-end items-end'>
                ...
                <Link href={'/Booking'} className='text-xl font-bold text-blue-600'>Sign in</Link>
            </div>
        </div>
    </div>
  )
