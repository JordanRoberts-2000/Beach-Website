...
const SignUpForm = () => {
    ...
    return (
        <form className='flex flex-col' onSubmit={(e) => handleSubmit(e)}>
            ...
            <Checkbox title={'Sign up to our newletter'} ref={newletterCheckbox} className='ml-8 mt-2 gap-4'/>
            <div className='mx-auto font-semibold text-sm text-red-600 h-4'>{formErrorMessage}</div>
            <button type='submit' className='bg-black text-white text-xl font-bold py-2 w-[85%] mt-2 mx-auto rounded-md'>Register</button>
        </form>
    )
}
