  ...
  return (
    <html lang="en" className={`${playfairDisplay.variable}`}>
        <ScrollLock>
            <Header/>
            <Main/>
            <p className="mx-4 mt-4 text-xl uppercase font-medium tracking-wide pb-8  font-playfairDisplay text-justify">Book from an array of exilerating activities and courses, great for families, the best beach beautiful sand</p>
