  ...
  return (
    <MainResize>
        <div className="relative h-[35vh] lg:h-full w-full flex flex-col">
            ...
            <div className="absolute bottom-0 left-[50%] translate-x-[-50%] w-[90%] lg:static mt-auto lg:translate-x-0 lg:w-fit lg:ml-[65%]">
                <RiseFade duration={.6} delay={.6} awaitPreload={true}>
                    <div className="flex mt-auto gap-12 z-30 mb-16 lg:mb-2">
                        <Link href={'/Booking'} className="border-2 font-sm shadow-lg py-1 text-center border-black backdrop-blur-sm flex-1 rounded-sm px-4 font-bold whitespace-nowrap
                                                 lg:hidden">
                            Book now
                        </Link>
                        <FindUsButton/>
            ...
            <RiseFade duration={.6} delay={1} awaitPreload={true} className={'flex items-center lg:items-start z-20 mb-4 lg:mb-16 lg:flex-col-reverse lg:ml-[65%]'} wrapperClassName="mt-auto lg:h-fit lg:mt-0">
