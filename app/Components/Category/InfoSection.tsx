        ...
        <>
            <div className="row-span-2 bg-[#F4FFFE] lg:bg-white flex flex-col">
                ...
                {priceOptions.map(({title, included, price}) => (
                    <div key={title} className="flex flex-col gap-2 pl-2 mb-4">
                        ...
                        <div className="flex">
                            <h6 className="text-2xl bg-black text-white px-2 w-fit pr-8">{`£${price}`}</h6>
                            <button className="ml-auto mr-2 font-extrabold px-3 border-2 border-black rounded-md">Book now</button>
                        </div>
            ...
            <div className="flex flex-col">
                ...
                <div className="flex flex-col">
                    ...
                    <p className="mr-2 font-bold">"Lorem ipsum dolor sit amet consectetur, adipisicing elit. Et consectetur aliquam excepturi nam nobis qui ex non voluptas. Ea officiis voluptate recusandae velit, ipsa soluta quibusdam! Veniam hic nisi recusandae."</p>
                    <span className="text-bold text-gray-700 text-sm mb-6"><span className="text-lg font-extrabold">- </span>Stephan oophean: 16/09/2022</span>
                </div>
                <div className="flex flex-col">
                    <div className="flex gap-2 mb-1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M11.48 3.499a.562.562 0 011.04 0l2.125 5.111a.563.563 0 00.475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 00-.182.557l1.285 5.385a.562.562 0 01-.84.61l-4.725-2.885a.563.563 0 00-.586 0L6.982 20.54a.562.562 0 01-.84-.61l1.285-5.386a.562.562 0 00-.182-.557l-4.204-3.602a.563.563 0 01.321-.988l5.518-.442a.563.563 0 00.475-.345L11.48 3.5z" /></svg>
