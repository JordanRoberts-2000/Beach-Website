    ...
    return (
        <>
            ...
            <nav className={`${!active ? "opacity-0 pointer-events-none" : "opacity-100 pointer-events-auto"} lg:opacity-100 lg:relative lg:bg-white/0 lg:h-auto 
                            lg:w-auto top-0 fixed h-[100dvh] w-[100%] left-0 bg-white duration-300 lg:ml-auto flex justify-end items-center flex-col lg:flex-row`}>
                <ul className='flex gap-12 mt-4 lg:mr-8 font-bold flex-col text-center text-3xl lg:text-base lg:flex-row lg:mt-0 w-fit mx-auto'>
                ...
                <div className="lg:hidden flex gap-4 mx-auto mb-4 mt-20">
