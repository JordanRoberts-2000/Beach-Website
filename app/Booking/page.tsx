    ...
    return (
        <div className='h-[90vh] flex flex-col'>
            ...
            <form className='flex flex-col gap-4 mx-8'>
                ...
                <button type='submit' className='bg-black text-white text-xl font-bold py-2 mt-4 rounded-md'>Sign In</button>
            </form>
            ...
            <p className='mx-8 mt-2 text-blue-300 text-xs text-center'>By Signing in you are agreeing to the terms and conditions</p>
            <div className='mt-2 mx-auto flex gap-4 justify-end items-end'>
